...
const drawerItems = [
  ...
  { label: 'All Task', icon: 'view-list-outline', screen: 'HomeTabs' },
  { label: 'My Bids', icon: 'gavel', screen: 'My Bids',parent: 'HomeTabs' },
  { label: 'Profile', icon: 'account-outline', screen: 'Profile'},
  { label: 'App Settings', icon: 'cog-outline', screen: 'Settings' },
